  ...
  const handleSaveCategory = async () => {
    ...
    try {
      if (editingCategory) {
        ...
        // The category id is a uuid generated by the database, so it is not
        // collected from the form — omit it and let the DB assign the key.
              ...
              {currentView === 'edit' && (
                <div>
                  ...
                  <input
                    type="text"
                    value={formData.id}
                    className="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg text-xs sm:text-sm font-mono bg-gray-50 cursor-not-allowed text-gray-500"
                    disabled
                  />
                  <p className="text-[10px] sm:text-xs text-gray-500 mt-1.5 sm:mt-2">
                    System-generated identifier — cannot be changed.
                  </p>
                </div>
              )}
