...
interface BatchOverviewTabProps {
  ...
  /** Every order on the batch; powers the end-of-batch closeout + CSV export. */
  orders?: BatchOrder[];
  /** Per-item closeout (orders, units, gross vs collected revenue) from the orders. */
  itemRevenue?: ItemRevenueSummary;
