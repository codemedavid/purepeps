 ...
 * hierarchy the stack was missing: a sticky rail that names the three areas
 * and jumps to them, and a numbered eyebrow over each panel. The title and
 * description now come from the shared AdminScreen frame around this panel.
 *
